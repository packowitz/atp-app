...
export class SettingsComponent {
  ...
  ionViewDidEnter() {
    Analytics.enterPage("Settings");
  }

  submitAtpAnswerable() {
    Analytics.event("notification_answerable_" + this.model.notificationSettings.atpAnswerableEnabled ? "enabled" : "disabled", {page: "Settings"});
  ...
  submitAtpFinished() {
    Analytics.event("notification_finished_" + this.model.notificationSettings.atpFinishedEnabled ? "enabled" : "disabled", {page: "Settings"});
  ...
  submitAnnouncement() {
    Analytics.event("notification_announcement_" + this.model.notificationSettings.announcementEnabled ? "enabled" : "disabled", {page: "Settings"});
  ...
  submitFeedback() {
    Analytics.event("notification_feedback_" + this.model.notificationSettings.feedbackEnabled ? "enabled" : "disabled", {page: "Settings"});
